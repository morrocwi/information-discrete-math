...
> One entry point — `idm.solve({"kind": ..., ...})` — over **265 registered problem kinds across 11
...
idm.kinds()          # the full list of 265 kind names
...
## Scope at a glance — 11 domains, 265 kinds
