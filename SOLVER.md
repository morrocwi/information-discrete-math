...
> One entry point — `idm.solve({"kind": ..., ...})` — over **263 registered problem kinds across 11
...
idm.kinds()          # the full list of 263 kind names
...
## Scope at a glance — 11 domains, 263 kinds
