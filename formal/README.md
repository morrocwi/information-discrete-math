...
**One command:** `bash formal/verify.sh` — compiles every witness and confirms all 37 theorems are axiom-free (*Closed under the global context*); exits 0 iff all pass.
