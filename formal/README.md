...
for the handful of kinds with a real proof mapping" (root README) — most of `idm`'s 266 registered
...
**One command:** `bash formal/verify.sh` — compiles every witness and confirms all 194 theorems are axiom-free (*Closed under the global context*); exits 0 iff all pass.
