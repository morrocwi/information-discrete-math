...
- Toledo equation codes: every equation, theorem and definition of the treatise, THEOREM.md, the skill and the Coq sources carries its Toledo code (root extension R2: 18 root rows δ_R, RD1–RD9, D, Z, Q, R, L_R, Keystone, A2, A3; 274 readings mapped to the Coq identifiers); `docs/TOLEDO_CODES.md` generated by `tools/toledo_codes.py`; README carries the Core Epistemic Structure block; the private sibling repository is referred to by role only. Toledo concept DOI 10.5281/zenodo.22537318.
