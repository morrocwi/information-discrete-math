...
tier)` registry with 266 registered kinds), a natural-language front end (`parse.py`), a certified-
...
**Limits.** The registry currently reports 266 registered kinds, but only a named subset carries a
