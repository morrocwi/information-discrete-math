...
tier)` registry with 265 registered kinds), a natural-language front end (`parse.py`), a certified-
...
**Limits.** The registry currently reports 265 registered kinds, but only a named subset carries a
