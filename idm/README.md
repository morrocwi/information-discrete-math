...
tier)` registry with 269 registered kinds), a natural-language front end (`parse.py`), a certified-
...
**Limits.** The registry currently reports 269 registered kinds, but only a named subset carries a
