...
**267 registered problem kinds** (`GET /kinds` lists them live; `idm.kinds()` in Python) — the 230-kind
...
`kind` through a registry, so related kinds share a computational core rather than being 267 disjoint
